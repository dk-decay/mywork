 ...
 */
public class ManageCompoundSynthesis extends javax.swing.JPanel {
    ...
    public ManageCompoundSynthesis(ChemicalManufacturer organization, JPanel container) {
        initComponents();
    ...
    public void populateDropDown() {
        Compound[] compoundArr = prepareDropDownModel();
        DefaultComboBoxModel compoundArrModel = new DefaultComboBoxModel(compoundArr);
        compoundListDropDown.setModel(compoundArrModel);
        if (compoundArr.length > 0) {
            compoundListDropDown.setSelectedItem(compoundArr[0]);
        }

    }

    public Compound[] prepareDropDownModel() {

        List<Compound> compoundList = this.organization.getCompoundList().stream()
                .filter(c -> c.getStatus() == Status.APPROVED)
                .collect(Collectors.toList());
        return compoundList.toArray(new Compound[compoundList.size()]);
    ...
    public void populateOrderTable() {
        ...
        model.setRowCount(0);
        this.organization.getChemicalSynthesisOrderList().stream()
                .forEach(o -> {
    ...
    private void submitBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitBtnActionPerformed
        // TODO add your handling code here:
        Compound compound = (Compound) compoundListDropDown.getSelectedItem();
        ChemicalSynthesisOrder cso = this.organization.createOrUpdateOrder(compound,
                Integer.valueOf(quantityField.getText()));
        cso.setSynthesizingManufacturerId(organization);
    ...
    private javax.swing.JComboBox<String> compoundListDropDown;
