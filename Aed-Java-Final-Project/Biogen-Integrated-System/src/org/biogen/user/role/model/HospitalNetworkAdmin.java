...
import org.biogen.network.admin.medicare.view.MedicareNetworkAdminWorkPanel;
 ...
 */
public class HospitalNetworkAdmin extends BusinessUserRole {

    public HospitalNetworkAdmin(RoleType type) {
        super(type);
    }

    @Override
    public JPanel retrieveWorkArea(Ecosystem system, JPanel container, BusinessUser user) {
       return new MedicareNetworkAdminWorkPanel(system, container, user);
    }
