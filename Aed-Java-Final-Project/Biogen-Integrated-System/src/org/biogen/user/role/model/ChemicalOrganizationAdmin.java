...
import org.biogen.organization.admin.chem.view.ChemOrgAdminMainWorkPanel;
 ...
 */
public class ChemicalOrganizationAdmin extends BusinessUserRole {

    public ChemicalOrganizationAdmin(RoleType type) {
        super(type);
    }

    @Override
    public JPanel retrieveWorkArea(Ecosystem system, JPanel container, BusinessUser user) {
        return new ChemOrgAdminMainWorkPanel(system, container, user);
    }
