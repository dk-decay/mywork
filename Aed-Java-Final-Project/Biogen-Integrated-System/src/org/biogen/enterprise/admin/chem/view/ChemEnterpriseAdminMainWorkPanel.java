 ...
 */
public class ChemEnterpriseAdminMainWorkPanel extends javax.swing.JPanel {

    /**
     * Creates new form ChemEnterpriseAdminWorkPanel
     */
    ...
    public ChemEnterpriseAdminMainWorkPanel(Ecosystem system, JPanel container, BusinessUser user) {
        initComponents();
        this.system = system;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Chemical Enterprise Work Area");
        ...
        analyticDashboardBtn.setText("Analytics Dashboard");
    ...
    private void mngWorkRequestBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mngWorkRequestBtnActionPerformed
        ...
        ManageWorkRequestPanel panel = new ManageWorkRequestPanel(system, user, enterprise, container);
        CardLayout layout = (CardLayout) container.getLayout();
        container.add("ManageWorkRequestPanel", panel);
    ...
    private void analyticDashboardBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_analyticDashboardBtnActionPerformed
        // TODO add your handling code here:
        ChemEnterpriseAnalyticsDashboard panel = new ChemEnterpriseAnalyticsDashboard(enterprise, container);
        CardLayout layout = (CardLayout) container.getLayout();
        container.add("ChemEnterpriseAnalyticsDashboard", panel);
        layout.next(container);
